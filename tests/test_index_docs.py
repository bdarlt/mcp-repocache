...
"""
        ...
        try:
            os.chdir(temp_dir)
            with patch('scripts.index_docs.yaml.safe_load') as mock_yaml_load:
                mock_yaml_load.return_value = yaml.safe_load(config_content)
        ...
        try:
            ...
            with patch('scripts.index_docs.load_config') as mock_load_config:
                ...
                with patch('scripts.index_docs.fetch_repo') as mock_fetch_repo:
                    ...
                    mock_fetch_repo.side_effect = GitCommandError("clone", "fatal: repository not found")
